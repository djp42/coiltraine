...
### IMPORT NEAR ACCIDENT SCENARIOS ###
sys.path.append(os.environ['TRI_HUMAN_MODELING'])
import coil_control_near_accident as carla09interface
######################
...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        ...
        type=int,
        default=0,
        help='Indicate which scenario to initialize.'
    )
